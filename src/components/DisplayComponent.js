...
class DisplayComponent extends BaseScreen {
        ...
        switch (this.state.displayType) {
            ...
            case 'vertical-album-grid':
                return this.minContent(<FlatGrid
                    ...
                    renderItem={({ item, index }) => this.displayGridAlbumItem(item, true)} />);
                break;
            case 'small-list':
    ...
    displayGridItem(item, index, vertical) {
        ...
        return (<View style={{ width: vertical ? null : 140, flex: 1 }}>
            <TouchableOpacity onPress={() => {
                ...
                style={{ borderRadius: 5, width: '100%', height: 130, marginBottom: 10, borderColor: '#D1D1D1', borderWidth: 1}}
                source={{
                    uri: item.art_md
                }}
                resizeMode={FastImage.resizeMode.cover}
    ...
    displayGridAlbumItem(item, vertical) {
        if (item === false) return null;
        return (<View style={{ width: vertical ? null : 140, flex: 1 }}>
            <TouchableOpacity onPress={() => {
            ...
            <CardItem cardBody header style={{ backgroundColor: this.theme.contentVariationBg }}>
                <FastImage source={{ uri: item.art_lg }} style={{ borderRadius: 5, height: 350, width: '95%', resizeMode: 'cover', marginTop: 5, marginLeft: 10, marginRight: 10 }}>
                    ...
                    <View style={{ flexDirection: 'row', bottom: 10, marginTop: 10, position: 'absolute', margin: 10 }}>
                        <Icon type="SimpleLineIcons" name="heart" style={{
                        ...
                        <Text style={{
                            ...
                            textShadowOffset: { width: -1, height: 1 },
                            textShadowRadius: 10,
                            color: '#fff', marginLeft: -10, fontSize: 12, bottom: 2, marginRight: 7, fontWeight: 'bold'
                        }}>{item.likeCount}</Text>

                        <Icon type="SimpleLineIcons" name="music-tone-alt" style={{
                            color: '#fff', fontSize: 20,
                            textShadowColor: 'rgba(0, 0, 0, 0.75)',
                            textShadowOffset: { width: -1, height: 1 },
                            textShadowRadius: 10,
                        ...
                        <Text style={{
                            textShadowColor: 'rgba(0, 0, 0, 0.75)',
                            textShadowOffset: { width: -1, height: 1 },
                            textShadowRadius: 10, color: '#fff', marginLeft: -10, fontSize: 12, bottom: 2, marginRight: 7, fontWeight: 'bold'
                        }}>{item.viewCount}</Text>

                        <Icon type="SimpleLineIcons" name="loop" style={{
                            color: '#fff', fontSize: 20, textShadowColor: 'rgba(0, 0, 0, 0.75)',
                            textShadowOffset: { width: -1, height: 1 },
                            textShadowRadius: 10,
                            marginLeft: 7
                        }} />
                        <Text style={{
                            ...
                            textShadowOffset: { width: -1, height: 1 },
                            textShadowRadius: 10, color: '#fff', marginLeft: -10, fontSize: 12, bottom: 2, marginRight: 7, fontWeight: 'bold'
                        }}>{item.repostCount}</Text>
                        <Icon type="SimpleLineIcons" name="bubble" style={{
                            color: '#fff', fontSize: 20, textShadowColor: 'rgba(0, 0, 0, 0.75)',
                            textShadowOffset: { width: -1, height: 1 },
                            textShadowRadius: 10,
                            marginLeft: 7
