        ...
        return this.minContent(
          <FlatGrid
            ...
            renderItem={({ item, index }) =>
              this.displayGridItem(item, index, false)
            }
          />
        );
        break;
      ...
      case "small-list":
        return this.minContent(
          <FlatList
            ...
            renderItem={({ item, index }) =>
              this.displaySmallListItem(item, index)
            }
          />
        );
        break;
    ...
    return (
      ...
      >
        ...
        >
          ...
          <Text style={{ marginTop: 10, color: "#777777" }}>
            {item.duration}
          </Text>
        </View>
      </TouchableOpacity>
  ...
  displayFeedItem(item, index) {
    ...
    if (item.action !== undefined) {
      switch (item.action) {
        case "posted-album":
          title = (
            <Text note>
              <Text note>{lang.getString("posted")}</Text>{" "}
              {lang.getString("an-album")}
            </Text>
          );
          break;
        ...
        case "repost-track":
          title = (
            <Text note>
              <Text note>{lang.getString("reposted")}</Text>{" "}
              {lang.getString("a-track")}
            </Text>
          );
          break;
        case "repost-album":
    ...
    return (
      <Card
        transparent
        style={{
          borderTopColor: this.theme.borderLineColor,
          borderTopWidth: 15,
      ...
      >
        ...
        >
          <Left style={{ flex: 1 }}>
            <FastImage
              source={{ uri: item.reposter.avatar }}
            ...
            <Body>
              ...
              >
                <Text>
                  <Text style={{ fontSize: 13, color: this.theme.blackColor }}>
                    {item.reposter.full_name}
                  </Text>{" "}
                  {title}
                </Text>
