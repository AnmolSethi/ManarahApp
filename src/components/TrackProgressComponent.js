    ...
    return (
      <View style={{ flexDirection: "column" }}>
        <View style={{ height: 25, margin: 5 }}>
          <Text
            style={{ color: "#fff", textAlign: "center", fontStyle: "italic" }}
          >
            {this.renderLyrics()}
          </Text>
        </View>
        {this.props.setup.progress === "bar" ? (
          <View
            onTouchStart={(e) => {
              this.seekTo(e);
            }}
          ...
          >
            <FastImage
              ...
              source={{ uri: this.track.wave }}
              style={{ flex: 1, width: waveWidth, height: 50 }}
            />
            <View
              style={{
                position: "absolute",
            ...
            >
              <FastImage
                resizeMode={FastImage.resizeMode.contain}
                source={{ uri: this.track.wave_colored }}
                style={{ flex: 1, width: waveWidth, height: 50 }}
              />
            </View>
          </View>
        ...
        <View style={{ flexDirection: "row", marginTop: 5 }}>
          ...
          <Text style={{ color: "#fff", flex: 1, textAlign: "right" }}>
