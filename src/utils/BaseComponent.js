          ...
          <Footer>
            <FooterTab>
              <Button
                ...
                active={this.activeMenu === "feed" ? true : false}
              >
              ...
              <Button
                ...
                active={this.activeMenu === "explore" ? true : false}
              >
              ...
              <Button
                ...
                active={this.activeMenu === "store" ? true : false}
              >
              ...
              <Button
                ...
                active={this.activeMenu === "collection" ? true : false}
              >
              ...
              {this.props.userid !== null && this.props.userid !== "" ? (
                <Button
                  vertical
                  badge={this.state.notifications > 0 ? true : false}
                  onPress={() =>
                    this.props.navigation.navigate("account", {
                      player: this.player,
                    })
                  }
                  active={this.activeMenu === "menu" ? true : false}
                >
