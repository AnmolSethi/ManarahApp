        ...
        return this.show(<Container style={{ flex: 1, backgroundColor: this.theme.contentVariationBg }}>
            ...
            {this.state.term === '' ? (<Tabs style={{
                ...
                <Tab heading={lang.getString('browse').toUpperCase()}>
                    <VideoComponent component={this} player={this.player} navigation={this.props.navigation} limit={6} type={this.state.term ? "search" : "latest"} typeId={this.state.term} />
                </Tab>
                <Tab heading={lang.getString('top-videos').toUpperCase()}>
                    <VideoComponent component={this} player={this.player} navigation={this.props.navigation} limit={6} type="top" typeId="" />
                </Tab>
            </Tabs>) : (<Tabs style={{
                paddingTop: 0,
                backgroundColor: this.theme.contentVariationBg,
                ...
                <Tab heading={lang.getString('search-results').toUpperCase()}>
                    <VideoComponent noCache={true} key={this.state.term} component={this} player={this.player} navigation={this.props.navigation} limit={6} type={this.state.term ? "search" : "latest"} typeId={this.state.term} />
                </Tab>
            </Tabs>)}
        </Container>)
    }
