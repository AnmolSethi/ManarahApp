      ...
      >
        ...
        >
          <Tab
            ...
            heading={lang.getString("listen-later").toUpperCase()}
          >
            <DisplayComponent
              key="listen-later"
              player={this.player}
          ...
          <Tab
            style={{ backgroundColor: this.theme.contentVariationBg }}
            heading={lang.getString("offline").toUpperCase()}
          >
            <DisplayComponent
              key="offline"
              player={this.player}
          ...
          <Tab
            style={{ backgroundColor: this.theme.contentVariationBg }}
            heading={lang.getString("history").toUpperCase()}
          >
            <DisplayComponent
              player={this.player}
              navigation={this.props.navigation}
          ...
          <Tab
            style={{ backgroundColor: this.theme.contentVariationBg }}
            heading={lang.getString("likes").toUpperCase()}
          >
            <DisplayComponent
              player={this.player}
              navigation={this.props.navigation}
          ...
          <Tab
            style={{ backgroundColor: this.theme.contentVariationBg }}
            heading={lang.getString("watch-later").toUpperCase()}
          >
            <VideoComponent
              player={this.player}
              navigation={this.props.navigation}
          ...
          <Tab
            style={{ backgroundColor: this.theme.contentVariationBg }}
            heading={lang.getString("watch-history").toUpperCase()}
          >
            <VideoComponent
              player={this.player}
              navigation={this.props.navigation}
