      ...
      >
        ...
        >
          <Tab
            ...
            heading={lang.getString("new-music").toUpperCase()}
          >
            <DisplayComponent
              player={this.player}
          ...
          <Tab
            style={{ backgroundColor: this.theme.contentVariationBg }}
            heading={lang.getString("best-of-week").toUpperCase()}
          >
            <DisplayComponent
              player={this.player}
              navigation={this.props.navigation}
              limit={10}
              type="store-best-week"
              typeId=""
              displayType="vertical-grid"
            />
          </Tab>
          <Tab
            style={{ backgroundColor: this.theme.contentVariationBg }}
            heading={lang.getString("videos").toUpperCase()}
          >
            <VideoComponent
              component={this}
              player={this.player}
          ...
          <Tab
            style={{ backgroundColor: this.theme.contentVariationBg }}
            heading={lang.getString("top-songs").toUpperCase()}
          >
            <DisplayComponent
              player={this.player}
              navigation={this.props.navigation}
              limit={10}
              type="store-top-songs"
              typeId=""
              displayType="vertical-grid"
            />
          </Tab>
          <Tab
            style={{ backgroundColor: this.theme.contentVariationBg }}
            heading={lang.getString("top-albums").toUpperCase()}
          >
            <DisplayComponent
              player={this.player}
              navigation={this.props.navigation}
              limit={10}
              type="store-top-albums"
              typeId=""
              displayType="vertical-album-grid"
            />
          </Tab>
        </Tabs>
      </Container>
