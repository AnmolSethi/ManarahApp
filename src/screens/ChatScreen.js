...
import { Container, Icon, Button, Header, Input, Item } from "native-base";
          ...
          <View style={{ flexDirection: "row" }}>
            ...
            >
              <Icon
                ...
                style={{ fontSize: 20, color: this.theme.whiteColor }}
              />
            </TouchableOpacity>
          ...
          <View style={{ flex: 1, flexDirection: "row" }}>
            ...
            <Item rounded style={{ flex: 1, marginLeft: 5 }}>
              <Input
                ...
                placeholder={lang.getString("enter-message")}
                onChangeText={(t) => this.updateState({ text: t })}
              />
            </Item>
            <Button
              onPress={() => {
        ...
        {this.props.userid === item.user.id ? (
          ...
          >
            <View style={{ alignSelf: "flex-end", flexDirection: "row" }}>
              ...
              >
                ...
                {this.displayOthersContent(item)}
              </View>
              <FastImage
                source={{ uri: this.props.avatar }}
                style={{ width: 30, height: 30, borderRadius: 20, margin: 5 }}
              />
            </View>
            <Text
              style={{
          ...
          >
            <View style={{ alignSelf: "flex-end", flexDirection: "row" }}>
              ...
              <View
                style={{
                  backgroundColor: this.theme.greyColor,
                  borderRadius: 15,
                  padding: 10,
                }}
              >
