    ...
    return this.show(
      <Container style={{ flex: 1 }}>
                ...
                {this.state.countNotifications > 0 ? (
                  ...
                  >
                    <Text style={{ color: "#fff" }}>
                      {this.state.countNotifications > 99
                        ? "99+"
        ...
        <Content style={{ backgroundColor: this.theme.contentVariationBg }}>
              ...
              {this.props.userid !== null ? (
                ...
                <View style={{ padding: 20, alignContent: "center" }}>
                  ...
                  >
                    ...
                    >
                      {lang.getString("sign-login-for-account")}
                    </Text>
                  </Button>
                </View>
              )}
          ...
          <ListItem
            itemDivider
            style={{ backgroundColor: this.theme.contentVariationBorderColor }}
          />
          <ListItem
            style={{ borderColor: this.theme.contentVariationBorderColor }}
            onPress={() => {}}
          >
            <Left>
              <Text
          ...
          {this.props.userid !== null && this.state.details !== null ? (
            <View>
              <ListItem
                itemDivider
                style={{
                  backgroundColor: this.theme.contentVariationBorderColor,
                }}
              ></ListItem>
              <ListItem
                style={{ borderColor: this.theme.contentVariationBorderColor }}
              ...
              >
                <Left>
                  <Text style={{ color: this.theme.blackColor, fontSize: 20 }}>
          ...
          {this.props.setup.terms_link ? (
            ...
            >
              <Left>
                <Text style={{ color: this.theme.blackColor, fontSize: 20 }}>
                  {lang.getString("terms-and-condition")}
                </Text>
              </Left>
              <Right>
                <Icon name="arrow-forward" />
