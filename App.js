...
export default class App extends Component<Props> {
  ...
  preLoad(data) {
    storage.preLoad((error, result) => {
      ...
      let language =
        result[7][1] === null ? setupData.default_language : result[7][1];
  ...
  render() {
    if (this.state.loaded) {
      const transitionConfig = () => {
        return {
          ...
          screenInterpolator: (sceneProps) => {
            ...
            return scene.route.routeName === "player"
      ...
      if (!this.state.userid) {
        ...
        if (
          this.state.didGetstarted === "0" ||
          this.state.didGetstarted === null
        )
          param.initialRouteName = "welcome";
      }
